...
/**
 * Get a list of common time zones formatted for select components
 * This function is used by TimeZoneSelector component
 * @returns Array of time zone options with label and value
 */
export function getCommonTimeZones() {
  return [
    ...
    { value: 'Europe/Paris', label: '(UTC+01:00) Berlin, Paris, Rome' },
...
/**
 * Parse a timezone offset string (like GMT+2) to get the offset value in hours
 * This function is used by AvailabilitySelector component
 * @param offsetStr - Timezone offset string (e.g., "GMT+2", "GMT-5")
 * @returns Offset in hours (can be positive or negative)
 */
export function parseTimeZoneOffset(offsetStr: string): number {
 ...
 */
export function utcToLocal(utcHour: number, tzOffset: number): number {
